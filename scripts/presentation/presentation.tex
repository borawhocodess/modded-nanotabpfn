...
\begin{frame}{Key points of the project}
  ...
  \begin{itemize}
    \item \hl{Speed} --- minimize wallclock pretraining to a fixed target
    \medskip
    \item \hl{Reproducibility} --- one file, fixed eval, anyone can rerun a record
    \medskip
    \item \hl{Insights} --- learn which tricks actually transfer and which matter
  \end{itemize}
\end{frame}
